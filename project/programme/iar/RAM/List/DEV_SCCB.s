...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  F:\K60_CAR_2018\lib\LPLD\DEV\DEV_SCCB.c
//    Command line =  
//        -f C:\Users\19071_~1\AppData\Local\Temp\EW8715.tmp
//        (F:\K60_CAR_2018\lib\LPLD\DEV\DEV_SCCB.c -D LPLD_K60 -D USE_K60DZ10
...
//    Locale       =  C
//    List file    =  F:\K60_CAR_2018\project\programme\iar\RAM\List\DEV_SCCB.s
//
///////////////////////////////////////////////////////////////////////////////
...
// F:\K60_CAR_2018\lib\LPLD\DEV\DEV_SCCB.c
//    1 /**
//    2 * @file DEV_SCCB.c
...
//   41   ptb.GPIO_PTx = PTE;
        ...
        STR      R0,[SP, #+4]
//   42   ptb.GPIO_Pins = GPIO_Pin12 | GPIO_Pin10;
        MOV      R0,#+5120
        STR      R0,[SP, #+8]
//   43   /********用户可修改值 结束***********/
...
//  155   SCCB_SDA_O=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_1  ;; 0x43fe2030
        STR      R0,[R1, #+0]
//  156   SCCB_SCL=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_2  ;; 0x43fe2028
        STR      R0,[R1, #+0]
//  157   SCCB_DELAY();
        MOVW     R0,#+5000
        BL       LPLD_SCCB_Delay
...
//  159   SCCB_SDA_IN();
        ...
        STR      R0,[R1, #+0]
//  160   if(!SCCB_SDA_I)
        LDR.N    R0,??DataTable7_4  ;; 0x43fe2230
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
