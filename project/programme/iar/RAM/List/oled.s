...
//    Locale       =  C
//    List file    =  F:\K60_CAR_2018\project\programme\iar\RAM\List\oled.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  261     write_cmd(0xcf);//--Set SEG Output Current Brightness
        MOVS     R0,#+207
        BL       write_cmd
//  262     write_cmd(0xa1);//--Set SEG/Column Mapping     0xa0左右反置 0xa1正常
        MOVS     R0,#+161
        BL       write_cmd
//  263     write_cmd(0xc8);//--Set COM/Row Scan Direction   0xc0上下反置 0xc8正常
        MOVS     R0,#+200
        BL       write_cmd
